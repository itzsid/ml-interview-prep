  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        {/* Overall Progress */}
        <div className="inline-flex items-center gap-4 bg-white rounded-lg px-6 py-3 shadow-sm border border-gray-200">
          ...
          <span className="text-primary-600 font-medium">{overallProgress}%</span>
        </div>
      </div>
        ...
        {sections.map((section, index) => {
          ...
          return (
            <Link
              ...
              className="group bg-white rounded-xl p-6 border border-gray-200 hover:border-primary-400 hover:shadow-md transition-all duration-200"
            >
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg p-6 text-center border border-gray-200">
          ...
          <h3 className="text-gray-900 font-medium mb-2">Python in Browser</h3>
        ...
        <div className="bg-white rounded-lg p-6 text-center border border-gray-200">
          <div className="text-3xl mb-3">✅</div>
          <h3 className="text-gray-900 font-medium mb-2">Instant Feedback</h3>
          <p className="text-gray-500 text-sm">
